...
function iframe_d_open(list) {
    ...
    if (iframe_d_list.content != "") {
        iframe_d_html += "<iframe id='"+iframe_d_list.id+"' class='iframe_d_iframe' src='" + iframe_d_list.content + "'></iframe>"
    }
    iframe_d_html +=
            "</div>" +
        "</div>";
    ...
    $(".iframe_d_form").css({
        "z-index": iframe_d_list.z_index + 1,
        "width": iframe_d_list.area.x + "px",
        "height": iframe_d_list.area.y + "px"
    })
